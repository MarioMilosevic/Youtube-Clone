...
const Categories = () => {
  ...
  const baseClass =
    "flex items-center gap-3 custom-color hover:bg-[#ff0000] hover:text-white hover:rounded-full px-2";

  return (
    <aside className="pt-12 px-2 flex flex-col justify-center gap-6 border w-[10%]">
